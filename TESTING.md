...
> **Note**<br>
> There are some [warnings](https://github.com/Toto-Kotaro-Tanaka/ms4-eagle-golf/blob/master/readme/testing/css-warnings.png) related to WebKit, for base.css, index.css and product.css. By investigating the internet I found that is best to ignore these errors, because of the use for different browsers it's better to have it than not.
...
> **Note**<br>
> Some files such as models.py (checkout app) and view.py(products app) I tried to change but because they broke the page I decide to leave the error as it is not too important, but mostly not ideal. [E501 - line too long ](https://github.com/Mathias-SantAnna/lotr-collectibles/blob/main/readme/testing/line-too-long.png)<br>
